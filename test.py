...
class mySVDPI(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.training:
            ...
            xxt = torch.mm(x, x.t())/(N*H) + torch.eye(C, out=torch.empty_like(x)) * self.eps
            ...
            xr = xr.view(C, N, H).transpose(0, 1)
            return xr
    ...
    def _load_from_state_dict(self, state_dict, prefix, metadata, strict,
        ...
        super(mySVDPI, self)._load_from_state_dict(
